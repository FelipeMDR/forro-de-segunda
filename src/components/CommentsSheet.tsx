...
export function CommentsSheet({
  ...
  return (
    ...
    >
      <div
        className="flex max-h-[75dvh] w-full max-w-md flex-col rounded-t-3xl border-t border-white/10 bg-noite-900"
            ...
            comments.map((c) => (
              <div key={c.id} className="flex items-start gap-2.5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="break-words text-sm text-stone-300">{c.texto}</p>
                </div>
